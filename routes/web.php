...
Route::get('/admin/{id}/show', 'AdminController@show');                     //No funciona 
...
Route::get('/admin/{$products->id}/edit', 'AdminController@edit');                     //No funciona
...
Route::get('/admin/showUser/{id}', 'AdminController@showClient');           //Funciona
